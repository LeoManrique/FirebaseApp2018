...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Activamos el ícono de Home par aregresar
    ...
    private void sendPost(){
        ...
        StorageReference storaRef = FirebaseStorage.getInstance().getReference("posts")
                .child(currentUser.getUid());
        final StorageReference photoRef = storaRef.child(localUri.getLastPathSegment());
                ...
                .addOnCompleteListener(new OnCompleteListener<Uri>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        ...
                        if(task.isSuccessful()) {
                            ...
                            // Cuando completó la carga ya podemos grabar el post
                            // Registrar el post
